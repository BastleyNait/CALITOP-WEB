...
const aboutCarouselImages = [
    {
        src: "https://f005.backblazeb2.com/file/CALITOP/img/1.png",
        alt: "CALITOP - Equipos topográficos y laboratorio de calibración"
    },
    {
        src: "https://f005.backblazeb2.com/file/CALITOP/img/3.png",
        alt: "CALITOP - Servicio técnico especializado en topografía"
    },
];
...
export default function AboutPage() {
    ...
    useEffect(() => {
        const timer = setInterval(() => {
            setCurrentImageIndex((prev) => (prev + 1) % aboutCarouselImages.length);
        }, 6000);
                        ...
                        >
                            <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl aspect-[4/3]">
                                <AnimatePresence mode="wait">
                                    ...
                                    >
                                        <Image
                                            src={aboutCarouselImages[currentImageIndex].src}
                                            alt={aboutCarouselImages[currentImageIndex].alt}
                                            fill
